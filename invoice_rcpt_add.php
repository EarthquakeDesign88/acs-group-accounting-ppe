...
<head>
	...
	<style type="text/css">
		div#show-listCust, div#show-listProj {
			position: absolute;
			z-index: 99;
			width: 100%;
...
<body>
	...
	<section>
		<div class="container">
			...
			<form method="POST" name="frmAddInvoiceRe" id="frmAddInvoiceRe" action="javascript:void(0)">
				<div class="row py-4 px-1" style="background-color: #E9ECEF">
					...
					<div class="col-md-12 d-none">
						...
						<input type="text" class="form-control" name="countChk" id="countChk" value="">
					</div>
				</div>
				<div class="row py-4 px-1" style="background-color: #FFFFFF">
					...
					<div class="col-md-12 pt-1 pb-3 <?php if ($obj_row_user["user_levid"] == 7) echo "d-none"; ?>">
						<div class="row">
					...
					<div class="col-md-3 pt-1 pb-3">
						...
						<input type="hidden" class="form-control " name="irno" id="irno">
					</div>
					<div class="col-md-3 pt-1 pb-3">
						...
						<div class="input-group">
							...
							<input type="date" class="form-control" name="invRedate" id="invRedate" autocomplete="off" tabindex="1" autofocus>
						</div>
						<div class="input-group">
							<input type="hidden" class="form-control" name="SelinvrcptDate" id="SelinvrcptDate">
							<input type="hidden" class="form-control" name="SelinvrcptYear" id="SelinvrcptYear">
							<input type="hidden" class="form-control" name="SelYear" id="SelYear">
						</div>
					</div>
					<div class="col-md-3 pt-1 pb-3">
					...
					<div class="col-md-9 pt-1 pb-3 <?php if ($cid = 'C009') echo "d-none"; ?>" id="showDataProject">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" name="searchProject" id="searchProject" placeholder="กรอกชื่อโครงการ" tabindex="3" autocomplete="off">
							<input type="text" class="form-control d-none" name="invReprojid" id="invReprojid" readonly>
							<div class="input-group-append">
								...
								document.getElementById('show-listProj').style.display = 'none';" title="Clear">
					...
					<div class="col-md-3 pt-1 pb-3 <?php if ($cid = 'C009') echo "d-none"; ?>">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" name="invRelesson" id="invRelesson" placeholder="กรอกงวด" tabindex="4" autocomplete="off">
						</div>
					</div>
					<div class="col-md-12 pt-1 pb-3" id="showDataCust">
						...
						<div class="input-group">
							...
							<input type="text" name="searchCustomer" id="searchCustomer" class="form-control" placeholder="กรอกบางส่วนของชื่อ-นามสกุล/ชื่อบริษัท" autocomplete="off" tabindex="5" value="">
					...
					<div class="col-md-12 pt-1 pb-3">
									...
									<div class="col-md-12">
										...
										<div class="row">
											<div class="col-md-9 pr-1">
												<input type="text" class="form-control my-1" name="invredesc1" id="invredesc1" autocomplete="off" tabindex="6" value="" placeholder="กรอกรายละเอียด">
												<input type="text" class="form-control my-1" name="invredesc2" id="invredesc2" autocomplete="off" tabindex="9" value="" placeholder="กรอกรายละเอียด">
												<input type="text" class="form-control my-1" name="invredesc3" id="invredesc3" autocomplete="off" tabindex="12" value="" placeholder="กรอกรายละเอียด">
												<input type="text" class="form-control my-1" name="invredesc4" id="invredesc4" autocomplete="off" tabindex="15" value="" placeholder="กรอกรายละเอียด">
												<input type="text" class="form-control my-1" name="invredesc5" id="invredesc5" autocomplete="off" tabindex="18" value="" placeholder="กรอกรายละเอียด">
												<div class="row px-0">
													<div class="col-md-9 pr-1">
														<input type="text" class="form-control" name="invredesc6" id="invredesc6" autocomplete="off" tabindex="21" value="" placeholder="กรอกรายละเอียด">
													</div>
													<div class="col-md-3 pl-1">
														<input type="text" class="form-control text-right" name="invresubdesc6" id="invresubdesc6" autocomplete="off" tabindex="22" value="0.0000" placeholder="กรอกจำนวนหน่วยคูณ">
														<input type="text" class="form-control text-right d-none" name="invresubdescHidden6" id="invresubdescHidden6" value="0.0000">
													</div>
												</div>
												
												<input type="text" class="form-control my-1" name="invredesc7" id="invredesc7" autocomplete="off" tabindex="25" value="" placeholder="กรอกรายละเอียด">
												<input type="text" class="form-control my-1" name="invredesc8" id="invredesc8" autocomplete="off" tabindex="28" value="" placeholder="กรอกรายละเอียด">
											</div>
											<div class="col-md-3 pl-1">
												<input type="text" class="form-control my-1 text-center" name="invresubdesc1" id="invresubdesc1" tabindex="7" autocomplete="off" value="" placeholder="กรอกเฉพาะตัวอักษร">
												<input type="text" class="form-control my-1 text-center" name="invresubdesc2" id="invresubdesc2" tabindex="10" autocomplete="off" value="" placeholder="กรอกเฉพาะตัวอักษร">
												<input type="text" class="form-control my-1 text-right" name="invresubdesc3" id="invresubdesc3" tabindex="13" autocomplete="off" value="0.0000" placeholder="กรอกเฉพาะตัวเลข">
												<input type="text" class="form-control my-1 d-none" readonly name="invresubdescHidden3" id="invresubdescHidden3" autocomplete="off" value="0.0000">
												<input type="text" class="form-control my-1 text-right" name="invresubdesc4" id="invresubdesc4" tabindex="16" autocomplete="off" value="0.0000" placeholder="กรอกเฉพาะตัวเลข">
												<input type="text" class="form-control my-1 d-none" readonly name="invresubdescHidden4" id="invresubdescHidden4" autocomplete="off" value="0.0000">
												<input type="text" class="form-control my-1 text-right" name="invresubdesc5" id="invresubdesc5" tabindex="19" autocomplete="off" value="0.0000" placeholder="กรอกเฉพาะตัวเลข">
												<input type="text" class="form-control my-1 d-none" readonly name="invresubdescHidden5" id="invresubdescHidden5" autocomplete="off" value="0.0000">
												<input type="text" class="form-control my-1 text-right" name="invresubdesc7" id="invresubdesc7" tabindex="23" autocomplete="off" value="0.0000" placeholder="กรอกเฉพาะตัวเลข">
												<input type="text" class="form-control my-1 d-none" readonly name="invresubdescHidden7" id="invresubdescHidden7" autocomplete="off" value="0.0000">
												<input type="text" class="form-control my-1 text-right" name="invresubdesc8" id="invresubdesc8" tabindex="26" autocomplete="off" value="0.0000" placeholder="กรอกเฉพาะตัวเลข">
												<input type="text" class="form-control my-1 d-none" readonly name="invresubdescHidden8" id="invresubdescHidden8" autocomplete="off" value="0.0000">
												<input type="text" class="form-control my-1 text-right" name="invresubdesc9" id="invresubdesc9" tabindex="29" autocomplete="off" value="0.0000" placeholder="กรอกเฉพาะตัวเลข">
												<input type="text" class="form-control my-1 d-none" readonly name="invresubdescHidden9" id="invresubdescHidden9" autocomplete="off" value="0.0000">
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-md-3 pl-1">
								<div class="row">
									<div class="col-md-12">
										...
										<input type="text" class="form-control my-1 text-right" name="amount1" id="amount1" autocomplete="off" tabindex="8" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden1" id="amountHidden1" value="0.00">
										<input type="text" class="form-control my-1 text-right" name="amount2" id="amount2" autocomplete="off" tabindex="11" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden2" id="amountHidden2" value="0.00">
										<input type="text" class="form-control my-1 text-right" name="amount3" id="amount3" autocomplete="off" tabindex="14" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden3" id="amountHidden3" value="0.00">
										<input type="text" class="form-control my-1 text-right" name="amount4" id="amount4" autocomplete="off" tabindex="17" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden4" id="amountHidden4" value="0.00">
										<input type="text" class="form-control my-1 text-right" name="amount5" id="amount5" autocomplete="off" tabindex="20" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden5" id="amountHidden5" value="0.00">
										<input type="text" class="form-control my-1 text-right" name="amount6" id="amount6" autocomplete="off" tabindex="24" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden6" id="amountHidden6" value="0.00">
										<input type="text" class="form-control my-1 text-right" name="amount7" id="amount7" autocomplete="off" tabindex="27" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden7" id="amountHidden7" value="0.00">
										<input type="text" class="form-control my-1 text-right" name="amount8" id="amount8" autocomplete="off" tabindex="30" value="0.00">
						...
						<div class="row">
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="row">
													...
													<div class="col-md-6">
														<input type="text" class="form-control my-1 text-right" name="vatpercent" id="showVatPercent" autocomplete="off" tabindex="35" value="0.00">
							...
							<div class="col-md-3 pl-1">
								<div class="row">
									<div class="col-md-12">
										<input type="text" class="form-control my-1 text-right" name="subtotal" id="showSubtotal" autocomplete="off" tabindex="34" value="0.00" readonly>
										<input type="text" class="form-control my-1 text-right d-none" name="subtotalHidden" id="calSubtotal" value="0.00" readonly>
									
										<input type="text" class="form-control my-1 text-right" name="vat" id="showVat" autocomplete="off" tabindex="36" value="0.00" readonly>
										<input type="text" class="form-control my-1 text-right d-none" name="vatHidden" id="calVat" value="0.00" readonly>
										<input type="text" class="form-control text-right" name="grandtotal" id="showGrandtotal" autocomplete="off" tabindex="38" value="0.00" readonly>
										<input type="text" class="form-control text-right d-none" name="grandtotalHidden" id="calGrandtotal" value="0.00" readonly>
									</div>
								</div>
							</div>
							<div class="col-md-1">
								<div class="row">
									<div class="col-md-12" style="padding-left: 0px;">
										...
										<input type="text" class="form-control my-1 text-right" name="diffvat" id="showDiffVat" autocomplete="off" tabindex="37" value="0.00">
										...
										<input type="text" class="form-control my-1 text-right" name="diffgrand" id="showDiffGrand" autocomplete="off" tabindex="39" value="0.00">
						...
						<div class="row">
							...
							<div class="col-md-7 pr-1">
								<h4>
									...
									โปรดชำระเงินภายในวันที่ <input type="date" class="form-control" style="display: inline-block; width: 50%" name="invrcptduedate" id="invrcptduedate">
								</h4>
							</div>
					...
					<div class="col-md-12 pt-1 pb-3">
							...
							<div class="col-md-7">
								<div class="row">
									<div class="col-md-12">
										...
										<input type="text" class="form-control my-1" name="invredesc1" id="invredesc1" autocomplete="off" tabindex="6" value="">
										<input type="text" class="form-control my-1" name="invredesc2" id="invredesc2" autocomplete="off" tabindex="7" value="">
										<input type="text" class="form-control my-1" name="invredesc3" id="invredesc3" autocomplete="off" tabindex="8" value="">
										<input type="text" class="form-control my-1" name="invredesc4" id="invredesc4" autocomplete="off" tabindex="9" value="">
										<input type="text" class="form-control my-1" name="invredesc5" id="invredesc5" autocomplete="off" tabindex="10" value="">
									
										<?php if($obj_row_comp["comp_id"] == 'C014' || $obj_row_comp["comp_id"] == 'C015') { ?>
											<input type="text" class="form-control my-1" name="invredesc6" id="invredesc6" autocomplete="off" tabindex="11" value="">
											<input type="text" class="form-control my-1" name="invredesc7" id="invredesc7" autocomplete="off" tabindex="12" value="">
											<input type="text" class="form-control my-1" name="invredesc8" id="invredesc8" autocomplete="off" tabindex="13" value="">
										<?php } else { ?>
											<input type="text" class="form-control my-1" name="invredesc6" id="invredesc6" autocomplete="off" tabindex="11" value="" readonly>
											<input type="text" class="form-control my-1" name="invredesc7" id="invredesc7" autocomplete="off" tabindex="12" value="" readonly>
											<input type="text" class="form-control my-1" name="invredesc8" id="invredesc8" autocomplete="off" tabindex="13" value="" readonly>							
										<?php }?>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="row">
									<div class="col-md-12">
										...
										<input type="text" class="form-control text-right my-1" name="amount1" id="amount1" autocomplete="off" tabindex="17" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden1" id="amountHidden1" value="0.00">
										<input type="text" class="form-control text-right my-1" name="amount2" id="amount2" autocomplete="off" tabindex="18" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden2" id="amountHidden2" value="0.00">
										<input type="text" class="form-control text-right my-1" name="amount3" id="amount3" autocomplete="off" tabindex="19" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden3" id="amountHidden3" value="0.00">
										<input type="text" class="form-control text-right my-1" name="amount4" id="amount4" autocomplete="off" tabindex="20" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden4" id="amountHidden4" value="0.00">
										<input type="text" class="form-control text-right my-1" name="amount5" id="amount5" autocomplete="off" tabindex="21" value="0.00">
										<input type="text" class="form-control text-right my-1 d-none" name="amountHidden5" id="amountHidden5" value="0.00">
										<?php if($obj_row_comp["comp_id"] == 'C014' || $obj_row_comp["comp_id"] == 'C015') { ?>
											<input type="text" class="form-control text-right my-1" name="amount6" id="amount6" autocomplete="off" tabindex="22" value="0.00">
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden6" id="amountHidden6" value="0.00">
											<input type="text" class="form-control text-right my-1" name="amount7" id="amount7" autocomplete="off" tabindex="23" value="0.00">
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden7" id="amountHidden7" value="0.00">
											<input type="text" class="form-control text-right my-1" name="amount8" id="amount8" autocomplete="off" tabindex="24" value="0.00">
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden8" id="amountHidden8" value="0.00">
										<?php } else { ?>
											<input type="text" class="form-control text-right my-1" name="amount6" autocomplete="off" tabindex="22" readonly>
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden6" id="amountHidden6" value="0.00">
											<input type="text" class="form-control text-right my-1" name="amount7" autocomplete="off" tabindex="23" readonly>
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden7" id="amountHidden7" value="0.00">
											<input type="text" class="form-control text-right my-1" name="amount8" autocomplete="off" tabindex="24" readonly>
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden8" id="amountHidden8" value="0.00">
										<?php }?>
									</div>
								</div>
						...
						<div class="row">
							...
							<div class="col-md-7">
								<div class="row">
									<div class="col-md-8">
										<input type="text" class="form-control my-1" name="invredesc9" id="invredesc9" autocomplete="off" tabindex="14" value="">
										<input type="text" class="form-control my-1" name="invredesc10" id="invredesc10" autocomplete="off" tabindex="15" value="">
										<input type="text" class="form-control my-1" name="invredesc11" id="invredesc11" autocomplete="off" tabindex="16" value="">
									</div>
									<div class="col-md-4">
										<div class="row">
											...
											<div class="col-md-12">
												<div class="row">
													<label class="col-md-6 col-form-label px-0 text-right">ภาษีมูลค่าเพิ่ม</label>
													<div class="col-md-6">
														<input type="text" class="form-control my-1 text-right" name="vatpercent" id="showVatPercent" autocomplete="off" tabindex="26" value="0.00">
														<input type="text" class="form-control my-1 text-right d-none" name="vatpercentHidden" id="calVatPercent" value="0.00" readonly>
													</div>
												</div>
											</div>
							...
							<div class="col-md-3">
								<div class="row">
									<div class="col-md-12">
										<input type="text" class="form-control my-1 text-right" name="subtotal" id="showSubtotal" autocomplete="off" tabindex="25" value="0.00" readonly>
										<input type="text" class="form-control my-1 text-right d-none" name="subtotalHidden" id="calSubtotal" value="0.00" readonly>
									
										<input type="text" class="form-control my-1 text-right" name="vat" id="showVat" autocomplete="off" tabindex="27" value="0.00" readonly>
										<input type="text" class="form-control my-1 text-right d-none" name="vatHidden" id="calVat" value="0.00" readonly>
										<input type="text" class="form-control text-right" name="grandtotal" id="showGrandtotal" autocomplete="off" tabindex="29" value="0.00" readonly>
										<input type="text" class="form-control text-right d-none" name="grandtotalHidden" id="calGrandtotal" value="0.00" readonly>
							...
							<div class="col-md-1">
								<div class="row">
									<div class="col-md-12" style="padding-left: 0px;">
										<label class="col-md-12 col-form-label px-0 mt-1 text-center">+ / -</label>
										<input type="text" class="form-control my-1 text-right" name="diffvat" id="showDiffVat" autocomplete="off" tabindex="28" value="0.00">
										<input type="text" class="form-control my-1 text-right d-none" name="DiffVatHidden" id="calDiffVat" autocomplete="off" value="0.00" readonly>
										<input type="text" class="form-control my-1 text-right" name="diffgrand" id="showDiffGrand" autocomplete="off" tabindex="30" value="0.00">
										<input type="text" class="form-control my-1 text-right d-none" name="DiffGrandHidden" id="calDiffGrand" autocomplete="off" value="0.00" readonly>
									</div>
								</div>
							</div>
					...
					<div class="col-md-12 pt-1 pb-3 d-none">
						...
						<input type="date" class="form-control" name="invrcptduedate" id="invrcptduedate">
					</div>
					<?php } ?>
				</div>
				<div class="row py-4 px-1" style="background-color: #FFFFFF;">
                                    ...
                                    success: function(result) {
                                        if(result.status == 1) {
                                            swal({
                                                ...
                                                window.open("export/invoice_rcpt_pdf.php?irID="+result.irID, '_blank');window.location.href ="invoice_rcpt.php?cid="+result.compid+"&dep="+result.depid;
                                            });
                                        } else {
