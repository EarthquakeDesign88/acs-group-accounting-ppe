							...
							<div class="col-md-3">
								<div class="row">
									<div class="col-md-12">
										...
										<?php } else { ?>
											<input type="text" class="form-control text-right my-1" name="amount6" vautocomplete="off" tabindex="20" readonly>
											<input type="text" class="form-control text-right my-1 d-none" name="amountHidden6" id="amountHidden6" value="0.00">
											...
											<div class="col-md-12">
												<div class="row">
													...
													<div class="col-md-6">
														...
														<input type="text" class="form-control my-1 text-right d-none" name="vatpercentHidden" id="calVatPercent" value="<?=$obj_row["invrcptD_vatpercent"];?>">
													</div>
												</div>
											</div>
